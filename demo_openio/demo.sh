export URL=http://127.0.0.41:6007/v1/AUTH_demo
export TOKEN=$(curl -v -H 'X-Storage-User: demo:demo' -H 'X-Storage-Pass: DEMO_PASS' http://127.0.0.41:6007/auth/v1.0 2>&1 | grep "X-Storage-Token" | grep -oP "AUTH_[a-zA-Z0-9]*")
